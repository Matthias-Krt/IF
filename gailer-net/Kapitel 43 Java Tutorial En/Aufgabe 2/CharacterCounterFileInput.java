/*Kapitel 43 Aufgabe 2
  Matthias Korte

  Modifizieren Sie Aufgabe 1 so das es die Zeilen aus einer Textdatei liest.
  Benutze dazu "input redirection" (Kapitel 22).
  Jede Zeile wird verarbeitet mit der Logik aus Aufgabe 1.

  Nachdem verarbeiten der Datei gib die Raw-Zahlen und die Prozentualenanteile jeder Kategorie
  in der Datei aus.
*/
...
class CharacterCounterFileInput{
