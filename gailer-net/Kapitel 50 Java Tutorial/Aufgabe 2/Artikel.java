...
class Artikel{
    ...
    public void anzeigen(){
        System.out.println("\n" + artikelNr + "\t" + bezeichnung + "\t EK:" + einkaufspreis + "\t VK:" + berechneVerkaufspreis(einkaufspreis) + " Euro \t Lagerzeit: " + lagerzeit + " Monate");
    }

    public int berechneVerkaufspreis(double einkaufsprs){
        einkaufspreis = einkaufsprs;

        einkaufspreis = einkaufspreis + (einkaufspreis * HANDELSSPANNE);
        einkaufspreis = einkaufspreis + einkaufspreis * MWST;
